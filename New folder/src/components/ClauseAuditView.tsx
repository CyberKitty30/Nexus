      ...
      <div className="lg:col-span-5 space-y-4">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-3 flex gap-2">
          <div className="flex-1">
            <label htmlFor="nexus-category-filter" className="text-[10px] text-slate-400 font-semibold uppercase block mb-1">Category</label>
            <select
              id="nexus-category-filter"
          ...
          <div className="flex-1">
            <label htmlFor="nexus-severity-filter" className="text-[10px] text-slate-400 font-semibold uppercase block mb-1">Severity</label>
            <select
              id="nexus-severity-filter"
              value={selectedRisk}
        ...
        {activeClause ? (
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-2xl space-y-5">
            ...
            <div className="pt-3 border-t border-slate-800 space-y-3">
              <label htmlFor="nexus-expert-notes-input" className="text-xs font-bold text-slate-200 uppercase tracking-wider block">
                Human Legal Expert Override & Review Notes:
              </label>

              <textarea
                id="nexus-expert-notes-input"
